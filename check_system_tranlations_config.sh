...
#sed '1d' system_translations.conf | cut -f 1 | grep -E -v "^#" > temp_config.txt
grep -E -v "^#" system_translations.conf | cut -f 1  > temp_config.txt
...
echo "==============================================="
echo Missing resources in system_translations.conf
echo "-----------------------------------------------"
...
echo "==============================================="
echo Over resources in system_translations.conf
echo "-----------------------------------------------"
echo -e $OVER | sed "s| |\n|g"
echo -e "===============================================\n\n"
...
echo "-----------------------------------------------"
grep none system_translations.conf | cut -f 1 | grep -E  "(desktop|desktop-ts|desktopts)$"
echo -e "===============================================\n\n"
...
echo "-----------------------------------------------"
grep none system_translations.conf | cut -f 1 | grep -E -v "(desktop|desktop-ts|desktopts)$"
echo -e "===============================================\n\n"
...
for i in $( grep -E -v "^ *#|none" system_translations.conf | sed -e 's/  *//g; s/\t\t*/;/g'); do
	#statements
	...
	if [[ $APP_NAME ]]; then
		...
		echo -e "Resource: $RESOURCE\nAPP_NAME not found in system_translations.conf\n"
	fi
